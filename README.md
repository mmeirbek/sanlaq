...
- **Текст на фоновой фотографии**: не приглушай фон — вешай на подпись
  вариацию темы `ScreenTitle`, `ScreenSubtitle` или `ScreenKicker`. Они дают
  тексту обводку, и он читается на любой картинке, а фон остаётся в полную силу.
